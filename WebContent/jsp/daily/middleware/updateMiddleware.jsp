 ...
 $(function(){
	 $.ajax({
			...
			success : function(data) {
				...
				$("#ip").val(data.ip);
				$("#middlewareOrder").val(data.middlewareOrder);
...
function addSystem(){
		 if(check()){
			 $.ajax({
				type : 'post',
				url : "${configRoot}/middleware/updateMiddleware.do",
				data : params,
...
<input type="hidden" id="status" />
	<table class="table table-bordered table-hover m10">
		<tr align="center">
			<td class="tableleft" style="height:30px;line-height:30px;width:15%;" align="center"><span style="color: red">*</span>中间件名称</span>
			</td>
			<td width="35%"><input type="text" name="name" id="name"/></td>
			<td class="tableleft" style="height:30px;line-height:30px;width:15%;" align="center"><span style="color: red">*</span>中间件ip</span></td>
