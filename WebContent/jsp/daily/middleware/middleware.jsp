...
<blockquote class="layui-elem-quote">
    ...
    <input type="text" class="common_search_ipt" name="serverName" placeholder="请输入要查询的中间件名称" style="margin-right:20px;" />
    	...
    	<table width="100%">
        	<thead>
            	<tr>
                    ...
                    <th width="5%">序号</th>
                    <th width="20%">中间件名称</th>
                    <th width="12%">中间件IP地址</th>
                    <th width="15%">中间件端口号</th>
                    <th width="10%">中间件运行环境</th>
                    <th width="16%">操作</th>
                </tr>
            </thead>
            <tbody id="mbody">
...
$(document).ready(function(e) {
    ...
    $("#common_btn_add").click(function(){
		parent.layer.open({
		  ...
		  shadeClose: true,
		  area: ['900px', '70%'], 
		  content: 'jsp/daily/middleware/addMiddleware.jsp'
		});
	});
    ...
    $("#common_btn_delete").click(function(){
    	...
    	if(!checkval || checkval.length<1){
    		...
    		parent.layer.confirm('您确定要删除该条记录吗？', {
    			  ...
    			  $.ajax({
    					type : 'post',
	    				url : Config.ROOT+"/middleware/deleteMiddleware.do",
			 			data : {
			 				ids : checkval
						},
