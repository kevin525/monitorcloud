...
function addTomcat(){
	 if(check()){
		 $.ajax({
			type : 'post',
			url : Config.ROOT+"/tomcat/saveTomcat.do",
			data : params,
...
function testConnect(){
	...
	testParam.version=$("select  option:selected").text();
...
<body>
	<table class="table table-bordered table-hover m10">
		...
		<tr align="center">
			...
			<td><input type="text" style="" name="managerUserName" id="managerUserName" value="admin"/></td>
			<td class="tableleft" style="height:30px;line-height:30px;" align="center"><span style="color:red;">*</span>角色密码</td>
			<td><input type="text" style="" name="managerPassword" id="managerPassword"  value="123456"/></td>
		</tr>
		<tr align="center">
			<td class="tableleft" style="height:30px;line-height:30px;" align="center"><span style="color:red;">*</span>角色</td>
			<td colspan="3"><input type="text" style="width:100%;" name="managerRole" id="managerRole"  value="manager,manager-gui,admin,manager-status,manager-jmx,manager-script"/></td>
		...
		<tr >
			<td colspan="4">
			    <button class="layui-btn layui-btn-normal" onclick="addTomcat()">添加</button>
