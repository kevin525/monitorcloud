    	...
    	<table width="100%">
            ...
            <tbody>
            	<tr bgcolor="#ffffff">
                    ...
                    <td align="center">2013-11-5</td>
                    <td align="center">10.171.251.67</td>
                    <td align="center">10.171.251.65</td>
                    <td align="center">刘刚</td>
                    <td align="center">刘刚</td>
                    <td align="center"><a href="javascript:void(0);" class="common_table_operate" style="margin-right:5px;">下线</a></td>
                </tr>
                <tr bgcolor="#f8f8f8">
                	<td align="center"><input type="checkbox"></td>
                    <td align="center">2</td>
                    <td align="left" style="padding:0 3px;">单点登录系统</td>
                    <td align="center">2013-11-5</td>
                    <td align="center">10.171.251.66</td>
                    <td align="center">10.171.251.65</td>
                    <td align="center">刘刚</td>
                    <td align="center">刘刚</td>
                    <td align="center"><a href="javascript:void(0);" class="common_table_operate" style="margin-right:5px;">下线</a></td>
