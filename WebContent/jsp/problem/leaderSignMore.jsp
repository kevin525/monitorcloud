...
<script type="text/javascript" src="${configRoot}/jsp/problem/leaderSignMore.js"></script>
...
<body>
      <div class="common_table_hd" style="margin-left:20px;">
		...
		<div class="common_search">
			...
			<a href="javascript:void(0);" class="btn_common"
				style="display: inline-block;" onclick="searchMoreInfo();">查 询</a>
		</div>

	 <div class="common_table_hd" style="margin-left:20px;">
		<a href="javascript:void(0);" class="common_btn_add"> <i
			class="icon_common_add"></i><span class="common_btn_name">第二步：查看重新签批的领导签批记录，获取领导上一步签批时间</span>
		</a>
	</div>
   ...
   <div class="common_table_hd" style="margin-left:20px;">
		<a href="javascript:void(0);" class="common_btn_add"> <i
			class="icon_common_add"></i><span class="common_btn_name">第三步：将上一步的签批时间复制给完成时间和修改时间</span>
		</a>
	</div>
	<div class="common_table">
	...
	<div class="common_table_hd" style="margin-left:20px;">
		<a href="javascript:void(0);" class="common_btn_add"> <i
			class="icon_common_add"></i><span class="common_btn_name">第五步：移动端图片处理，单击图片处理</span>
		</a>
	</div>
	<div style="margin-left:20px;">
	   <a href="javascript:void(0);" class="btn_common"
				style="display: inline-block;" onclick="copySignPic()">图片处理</a>
	</div>
	<div class="common_table_hd" style="margin-left:20px;">
		<a href="javascript:void(0);" class="common_btn_add"> <i
			class="icon_common_add"></i><span class="common_btn_name">第六步：从PC端重新把公文送给领导</span>
		</a>
	</div>
