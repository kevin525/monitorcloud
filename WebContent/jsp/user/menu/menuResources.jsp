...
<blockquote class="layui-elem-quote">
    ...
    <input type="text" class="common_search_ipt" name="sAppName" placeholder="请输入要查询的菜单名称" style="margin-right:20px;" />
    ...
    $("#common_btn_delete").click(function(){
    	...
    	if(!checkval || checkval.length<1){
    		...
    		parent.layer.confirm('您确定要删除该条记录吗？', {
    			  ...
    			  $.ajax({
    					type : 'post',
    					url : "${configRoot}/menuResource/deleteMenuResource.do",
			 			data : {
			 				ids : checkval
						},
