...
<div class="common_search">
	<span class="common_search_fieldName">更新系统：</span>
    <input type="text" class="common_search_ipt" placeholder="请输入要查询的更新系统" style="margin-right:20px;" />
    <span>更新时间：</span>
...
<div class="common_table">
	<div class="common_table_hd">
        ...
        <a href="javascript:void(0);" class="common_btn_import">
        	<i class="icon_common_import"></i><span class="common_btn_name">导出更新情况</span>
        </a>
    </div>
    	...
    	<table width="100%">
            ...
            <tbody>
            	<tr bgcolor="#ffffff">
                    ...
                    <td align="left" style="padding:0 3px;">通州OA系统</td>
                ...
                <tr bgcolor="#f8f8f8">
                    ...
                    <td align="left" style="padding:0 3px;">移动服务端</td>
                    <td align="center">2017-1-5</td>
