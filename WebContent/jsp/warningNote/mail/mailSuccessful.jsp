...
<title>邮件成功发送列表</title>
<%@ include file="/WEB-INF/jsp/common/initVariables.jsp"%>
<link href="${configRoot}/css/layout.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${configRoot}/jsp/warningNote/mail/mailSuccessful.js"></script>
</head>
<body>
<blockquote class="layui-elem-quote">
<span class="common_search_fieldName">邮件内容：</span>
    <input type="text" class="common_search_ipt" name="sAppName" placeholder="请输入要查询的邮件内容" style="margin-right:20px;width:300px;" />
    ...
    $("#common_btn_delete").click(function(){
    	...
    	if(!checkval || checkval.length<1){
    		...
    		parent.layer.confirm('您确定要删除该条记录吗？', {
    			  ...
    			  $.ajax({
    					type : 'post',
	    				url : Config.ROOT+"/mail/deleteAsopMail.do",
			 			data : {
			 				ids : checkval
						},
