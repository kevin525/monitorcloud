...
<title>短消息成功发送列表</title>
<%@ include file="/WEB-INF/jsp/common/initVariables.jsp"%>
<link href="${configRoot}/css/layout.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${configRoot}/jsp/warningNote/inform/unreadInform.js"></script>
</head>
<body>
<blockquote class="layui-elem-quote">
<span class="common_search_fieldName">短消息内容：</span>
    <input type="text" class="common_search_ipt" name="sAppName" placeholder="请输入要查询的短消息内容" style="margin-right:20px;width:300px;" />
...
$(document).ready(function(e) {
    ...
    $("#common_btn_delete").click(function(){
    	var id = getCheckedValue("systemstate");
    	if(!id || id.length<1){
    		parent.layer.confirm('请选择要批量已读的记录！', {
    			  btn: ['关闭'] //按钮
    		});
    	}else{
    		parent.layer.confirm('您确定要批量已读记录吗？', {
    			  btn: ['确定','取消'] //按钮
    		}, function(){
    			  $.ajax({
    					type : 'post',
