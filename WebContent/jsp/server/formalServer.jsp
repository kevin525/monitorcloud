    	...
    	<table width="100%">
            ...
            <tbody>
            	<tr bgcolor="#ffffff">
                    ...
                    <td align="left" style="padding:0 3px;">10.171.251.76</td>
                    <td align="center">代办中心正式平台</td>
                    <td align="left" style="padding:0 3px;">E:\代办中心正式平台\tzdesk</td>
                ...
                <tr bgcolor="#f8f8f8">
                    ...
                    <td align="left" style="padding:0 3px;">10.171.251.76</td>
                    <td align="center">短信平台</td>
                    <td align="left" style="padding:0 3px;">E:\短信平台\asopsms</td>
                ...
                <tr bgcolor="#ffffff">
                    ...
                    <td align="left" style="padding:0 3px;">10.171.251.76</td>
                    <td align="center">经信委请假</td>
                    <td align="left" style="padding:0 3px;">E:\app\zsjxwqjgl</td>
                ...
                <tr bgcolor="#f8f8f8">
                    ...
                    <td align="left" style="padding:0 3px;">10.171.251.70</td>
                    <td align="center">文件转换服务器</td>
                    <td align="left" style="padding:0 3px;">D:\asop\tomcatAsopdc</td>
                    <td align="center">8083</td>
                    <td align="center">administrator</td>
                    <td align="center">123456</td>
                    <td align="center"><a href="javascript:void(0);" class="common_table_operate" style="margin-right:5px;">修改</a><a href="javascript:void(0);" class="common_table_operate">删除</a></td>
