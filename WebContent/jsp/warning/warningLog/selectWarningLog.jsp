...
function check(){
	...
	params.projectName = $("#projectName").text();
	params.personLiable = $("#personLiable").text();
	...
	<div id="step_one">
			<table class="table table-bordered table-hover m10">
				...
				<tr>
					...
					<td><textarea name="warnDesc" id="warnDesc" style="width:500px;height:100px;" disabled="disabled"/></textarea></td>
				</tr>
