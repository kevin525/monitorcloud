...
public class RSAUtils {
	/** 默认的安全服务提供者 */
    private static final Provider DEFAULT_PROVIDER = new org.bouncycastle.jce.provider.BouncyCastleProvider();
  ...
  //删除所有登录信息
  	static public void removeRSAMap(){
  		synchronized (map) {
